...
一個具體的對照（2026-08 價格）：一張 RTX 5090 約 $4,700，256 GB 的 DDR5 RDIMM 約 $3,481。在 offload 場景把預算投在記憶體仍然較划算——**因為瓶頸從來不在那張卡上**——但要注意這個價差已經被 RAM 漲價壓縮了很多，一年前同樣容量的記憶體不到現在的五分之一。完整報價見 [硬體與成本](llm-hardware-cost-2026.md)。
